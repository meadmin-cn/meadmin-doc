...
<span class="line"><span>│   │   ├── template自动生成模板</span></span>
<span class="line"><span>│   │   ├── types  类型文件</span></span>
<span class="line"><span>└── └── └── vite.config.ts vite配置文件</span></span></code></pre></div><h2 id="赞助" tabindex="-1">赞助 <a class="header-anchor" href="#赞助" aria-label="Permalink to “赞助”">​</a></h2><p>如果能帮到您欢迎打赏。赞助时务必备注github name 后期将更新到赞助列表中。</p><p><img src="`+l+'" alt=""></p>',20)])])}const u=n(i,[["render",t]]);export{m as __pageData,u as default};
